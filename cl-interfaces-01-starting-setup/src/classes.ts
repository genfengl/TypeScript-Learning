...
abstract class Department {
  ...
  // empty method for abstract, so that inherited classes can implement their own version of this method
  //   abstract forces classes to share a same method
